...
<!-- 가운데 카카오 지도 -->
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f4bb9f224f298dcd754083df04429703"></script>
	<script>
		var container = document.getElementById('map');
		var options = {
			center: new kakao.maps.LatLng(35.12907159179403, 126.8531730541552),
			level: 9
		};
...
//행정구역 구분
$.getJSON("./assets/json/gj_qgis.geojson", function(geojson) {
